...
import com.example.ReportingService.client.LeaveClient;
import com.example.ReportingService.client.TrainingClient;
import com.example.ReportingService.client.UserClient;
import com.example.ReportingService.dto.*;
import com.example.ReportingService.entity.*;
import com.example.ReportingService.exception.ExternalServiceException;
import com.example.ReportingService.exception.ReportGenerationException;
import com.example.ReportingService.exception.ReportNotFoundException;
import com.example.ReportingService.mapper.ReportMapper;
import com.example.ReportingService.repository.ReportSnapshotRepository;
...
public class ReportingService {
    ...
    public PageResponse<ReportHistoryResponse> getReportHistory(int page, int size, String search) {
        ...
        Page<ReportSnapshot> reportPage = reportSnapshotRepository.searchReports(search, pageable);
